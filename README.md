...
<p>Below are  some key visualisations generated by the code. You can save your plots (e.g. via <code>plt.savefig('filename.png')</code>) and embed them here.</p>

<div class="plot-container">
    <h5>Distribution Plot (Actual vs Predicted)</h5>
    <!-- Replace 'distribution_plot.png' with your actual plot file -->
    <img src="distribution_plot.png" alt="Distribution Plot">
    <p class="note">DistributionPlot output.</p>
</div>

<div class="plot-container">
    <h5>Polynomial Fit Plot</h5>
    <!-- Replace 'polynomial_plot.png' with your actual plot file -->
    <img src="polynomial_plot.png" alt="Polynomial Plot">
    <p class="note">PollyPlot output.</p>
</div>

<div class="plot-container">
    <h5>Alpha vs R² (Ridge Regression)</h5>
    <!-- Replace 'alpha_vs_r2.png' with your actual plot file -->
    <img src="alpha_vs_r2.png" alt="Alpha vs R² Plot">
    <p class="note">R² vs Alpha plot.</p>
</div>
